...
function SettingsController($scope, SharedService) {
    ...
    $scope.settings = {
        auth: 'auth', region: '', bucket: '', entered_bucket: 's3uploader-s3bucket-1i48cdq64q79w', selected_bucket: '', view: 'folder', delimiter: '/', prefix: '',
    };
    $scope.settings.mfa = { use: 'no', code: '' };
    $scope.settings.cred = { accessKeyId: 'AKIA4I6M3LMMTO3IBZ53', secretAccessKey: '', sessionToken: '' };
